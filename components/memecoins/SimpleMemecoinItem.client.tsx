...
export default function SimpleMemecoinItem({coin}: { coin: Memecoin }) {
    return (
        <Link href={`/memecoins/${coin.id}`} className="block">
            <div className="w-full bg-gradient-to-br from-white to-indigo-50 rounded-lg border border-indigo-100 shadow-sm hover:shadow-md p-4 cursor-pointer">
                ...
                {/* Button below */}
                <div className="mt-4">
                    <Button variant="default" className="text-white bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-700 hover:to-indigo-600 w-full shadow-sm">
